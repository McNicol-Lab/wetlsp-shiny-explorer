...
phenometric_scale_type <- function(layer_name) {
  # WetLSP / Moon et al. 2022 product names:
...
wetlsp_layer_dictionary <- function() {
  tibble::tribble(
...
wetlsp_layer_label <- function(layer_name) {
  dict <- wetlsp_layer_dictionary()
...
server <- function(input, output, session) {
  ...
  output$pheno_layer_ui <- renderUI({
    ...
    layer_choices <- stats::setNames(layers, vapply(layers, wetlsp_layer_label, character(1)))
